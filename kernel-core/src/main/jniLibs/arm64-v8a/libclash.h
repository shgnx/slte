...
extern void setAgeSecretKey(c_string key);
extern char* genX25519KeyPair(void);
extern char* genHybridKeyPair(void);
extern int veritySecretKeys(c_string secretKeys);
extern char* toPublicKeys(c_string secretKeys);
extern int verityPublicKeys(c_string publicKeys);
